...
<img alt="Multiple Axes Chart" src={useBaseUrl('/images/ma1.png')} />
...
<img alt="Visualization Settings" src={useBaseUrl('/images/ma2.png')} />
...
<img alt="Visualization Settings" src={useBaseUrl('/images/ma3.png')} />
...
<img alt="License" src={useBaseUrl('/images/ma4.png')} />
...
<img alt="General" src={useBaseUrl('/images/ma5.png')} />
...
<img alt="Data Source" src={useBaseUrl('/images/ma6.png')} />
...
<img alt="Global Fonts" src={useBaseUrl('/images/ma7.png')} />

The below Figure represents the Multiple Axes Chart with Fonts being
configured as Arial.

<img alt="Global Fonts in Multiple Axes Chart" src={useBaseUrl('/images/ma8.png')} />
...
<img alt="Position in X Axis" src={useBaseUrl('/images/ma9.png')} />
...
Display" src={useBaseUrl('/images/ma14.png')} />
...
<img alt="Inner Padding in X Axis" src={useBaseUrl('/images/ma15.png')} />
...
%" src={useBaseUrl('/images/ma16.png')} />

5.  Enable the property Title (see Figure below). Set the Title as
    \"Product Details\".

<img alt="Title in X Axis" src={useBaseUrl('/images/ma17.png')} />
...
Axis" src={useBaseUrl('/images/ma18.png')} />
...
<img alt="Reverse Axis" src={useBaseUrl('/images/ma19.png')} />
...
Axis" src={useBaseUrl('/images/ma20.png')} />

8.  Enable the property Axis Label (see Figure below).

<img alt="Axis Label" src={useBaseUrl('/images/ma21.png')} />
...
<img alt="Multiple Axes Chart with Axis Label" src={useBaseUrl('/images/ma22.png')} />
...
<img alt="Maximum Height (%)" src={useBaseUrl('/images/ma23.png')} />
...
5" src={useBaseUrl('/images/ma27.png')} />
...
<img alt="Position in Y-Axis 1 Configuration" src={useBaseUrl('/images/ma28.png')} />
...
Chart" src={useBaseUrl('/images/ma29.png')} />
...
<img alt="Scale Type and Auto Scaling" src={useBaseUrl('/images/ma30.png')} />
...
Chart" src={useBaseUrl('/images/ma31.png')} />
...
4.  Set the property Display Units to the option Thousands and set the
    ...
    Places" src={useBaseUrl('/images/ma33.png')} />
...
> Places for Y Axis" src={useBaseUrl('/images/ma34.png')} />
...
> <img alt="Series Type Selection" src={useBaseUrl('/images/ma35.png')} />
...
types" src={useBaseUrl('/images/ma36.png')} />
...
> <img alt="Series Type Selection" src={useBaseUrl('/images/ma37.png')} />
...
colors" src={useBaseUrl('/images/ma38.png')} />
...
> <img alt="Data Label Settings" src={useBaseUrl('/images/ma39.png')} />
...
> Chart" src={useBaseUrl('/images/ma39a.png')} />
...
> Chart" src={useBaseUrl('/images/ma40.png')} />
...
> Chart" src={useBaseUrl('/images/ma41.png')} />
...
> grids" src={useBaseUrl('/images/ma42.png')} />
...
> grids" src={useBaseUrl('/images/ma43.png')} />
...
1.  Navigate to the Area Analytics in the category Format. You have the
    ...
    <img alt="Error Bars" src={useBaseUrl('/images/ma44.png')} />
...
> Bars" src={useBaseUrl('/images/ma45.png')} />
...
1.  Navigate to the Area Legend in the category Format. You have the
    ...
    <img alt="Enable Legend" src={useBaseUrl('/images/ma56.png')} />
...
> Chart" src={useBaseUrl('/images/ma57.png')} />

2.  Activate the property Enable RTL Support as shown in the below
    Figure.

    <img alt="Enable RTL Support" src={useBaseUrl('/images/ma58.png')} />
...
> <img alt="Legends with RTL Support" src={useBaseUrl('/images/ma59.png')} />

2.  Activate the property Show Single Series as shown in the below
    Figure.

    <img alt="Enable Show Single Series" src={useBaseUrl('/images/ma60.png')} />
...
> Series" src={useBaseUrl('/images/ma61.png')} />
...
1.  Navigate to the Area Tooltip in the category Format. You have the
    ...
    <img alt="Enable Tooltip" src={useBaseUrl('/images/ma62.png')} />

Based on the above configuration, you will be able to view the Multiple
Axes Chart being configured with the Tooltip.

> <img alt="Multiple Axes Chart with Tooltip" src={useBaseUrl('/images/ma63.png')} />

2.  Activate the property Shared Tooltip as shown in the below Figure.

    <img alt="Enable Shared Tooltip" src={useBaseUrl('/images/ma64.png')} />
...
> Tooltip" src={useBaseUrl('/images/ma65.png')} />
...
3.  A Report can be also shown as a Tooltip when clicking the chart
    ...
    <img alt="Pie Chart in Page 2" src={useBaseUrl('/images/ma66.png')} />
...
4.  Now navigate to the Page 2 Format Category (see Figure below). In
    ...
    <img alt="Page 2 Format Category" src={useBaseUrl('/images/ma67.png')} />
...
5.  Now navigate to the Format Category of the Multiple Axes Chart in
    ...
    1" src={useBaseUrl('/images/ma68.png')} />
...
> Tooltip" src={useBaseUrl('/images/ma69.png')} />
...
1.  Navigate to the Area Miscellaneous in the category Format. You have
    ...
    <img alt="Enable Pan and Zoom" src={useBaseUrl('/images/ma70.png')} />
...
3.  Now activate the property Enable Footer as shown in the below
    ...
    <img alt="Enable Footer" src={useBaseUrl('/images/ma71.png')} />

Based on the above configuration, you will be able to view the Multiple
Axes Chart showing the configured Footer settings as shown below.

> <img alt="Footer in Multiple Axes Chart" src={useBaseUrl('/images/ma72.png')} />

4.  Activate the property Enable Hierarchy as shown in the below Figure.

    <img alt="Enable Hierarchy" src={useBaseUrl('/images/ma73.png')} />
...
1.  Navigate to the Area Data Measures in the category Format (see
    ...
    <img alt="Data Measures" src={useBaseUrl('/images/ma74.png')} />
...
> Amount" src={useBaseUrl('/images/ma75.png')} />
...
1.  Navigate to the Area Utility Menu in the category Format. You have
    ...
    <img alt="Enable Utility Menu" src={useBaseUrl('/images/ma76.png')} />
...
2.  By enabling the Utility Menu, you will be able to view a Context
    ...
    <img alt="Context Menu" src={useBaseUrl('/images/ma77.png')} />
...
-   Lasso - The Lasso option will select those elements in the chart
    ...
    <img alt="Lasso Selection" src={useBaseUrl('/images/ma78.png')} />
...
> <img alt="Lasso Selection" src={useBaseUrl('/images/ma78a.png')} />
...
-   Reverse Lasso - The Reverse Lasso option will select those elements
    ...
    <img alt="Reverse Lasso Selection" src={useBaseUrl('/images/ma79.png')} />
...
> <img alt="Reverse Lasso Selection" src={useBaseUrl('/images/ma79a.png')} />
...
-   Zoom - This property enables the zoom function for the selected area
    ...
    <img alt="Before Zoom Selection" src={useBaseUrl('/images/ma80.png')} />

The below Figure shows the zoomed view of the selected dimension
members.

> <img alt="After Zoom Selection" src={useBaseUrl('/images/ma81.png')} />
