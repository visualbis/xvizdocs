...
<img alt="Horizon Chart" src={useBaseUrl('/images/hr1.png')} />
...
<img alt="Visualization Settings" src={useBaseUrl('/images/hr2.png')} />
...
<img alt="License" src={useBaseUrl('/images/hr3.png')} /> 
...
<img alt="General" src={useBaseUrl('/images/hr4.png')} />
...
configuration" src={useBaseUrl('/images/hr5.png')} />
...
<img alt="Base Value" src={useBaseUrl('/images/hr6.png')} />
...
configuration" src={useBaseUrl('/images/hr7.png')} />
...
<img alt="Base Value" src={useBaseUrl('/images/hr8.png')} />
...
configuration" src={useBaseUrl('/images/hr9.png')} />
...
<img alt="Color Scheme" src={useBaseUrl('/images/hr10.png')} />
...
Scheme" src={useBaseUrl('/images/hr11.png')} />
...
1.  Navigate to the Area Legend in the category Format. You have the
    ...
    <img alt="Enable Legend" src={useBaseUrl('/images/hr12.png')} />
...
> <img alt="Legend Settings in Horizon Chart" src={useBaseUrl('/images/hr13.png')} />
...
1.  Navigate to the Area Number Formatting in the category Format. You
    ...
    <img alt="Number Formatting" src={useBaseUrl('/images/hr14.png')} />
...
> Chart" src={useBaseUrl('/images/hr15.png')} />
...
1.  Navigate to the Area Global Fonts in the category Format. You have
    ...
    <img alt="Global Fonts" src={useBaseUrl('/images/hr16.png')} />
...
> Chart" src={useBaseUrl('/images/hr17.png')} />
