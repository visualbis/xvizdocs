...
General Features of the Visuals
=============================
...
> <img alt="Advance Editor option" src={useBaseUrl('/images/ae1.png')} />

When clicked it will navigate to the Advance Editor window (see Figure
below).

> <img alt="Advance Editor Window" src={useBaseUrl('/images/ae2.png')} />
...
7.  Based on the above set of configuration for Rule 1, the Multiple
    ...
    Type as Number" src={useBaseUrl('/images/cf4.png')} />
...
1.  Set the Rule Name as Rule 1 (see Figure below).
    ...
    <img alt="Condition Formatting Rule" src={useBaseUrl('/images/cf5.png')} />
...
5.  Set the property Comparison Type to the option Data Selection. You
    ...
    <img alt="Data Sheet" src={useBaseUrl('/images/cf6.png')} />
...
6.  Based on the above set of configuration for Rule 1, the Multiple
    ...
    <img alt="Multiple Axes Chart with Conditional Formatting Rule - Comparison
    Type as Data Selection" src={useBaseUrl('/images/cf7.png')} />

### Steps for the configuration of Comparison Type as Value

1.  Set the Rule Name as Rule 1 (see Figure below).

    <img alt="Condition Formatting Rule" src={useBaseUrl('/images/cf8.png')} />
...
7.  Based on the above set of configuration for Rule 1, the Multiple
    ...
    Value" src={useBaseUrl('/images/cf9.png')} />

### Steps for the configuration of Comparison Type as Calculation

1.  Set the Rule Name as Rule 1 (see Figure below).

    <img alt="Condition Formatting Rule" src={useBaseUrl('/images/cf10.png')} />
...
7.  Now you will be able to select the number from the assigned data
    ...
    <img alt="Data Sheet 1" src={useBaseUrl('/images/cf11.png')} />
...
> <img alt="Data Sheet 2" src={useBaseUrl('/images/cf12.png')} />
...
> <img alt="Multiple Axes Chart with Conditional Formatting Rule -
> Calculation" src={useBaseUrl('/images/cf13.png')} />
...
1.  For our example, add the Color Scale by clicking the Color Scale
    ...
    <img alt="Color Scale Icon" src={useBaseUrl('/images/cf14.png')} />

2.  Set the Rule Name to Rule 1 (see Figure below).

    <img alt="Condition Formatting Rule" src={useBaseUrl('/images/cf15.png')} />
...
6.  Based on the above set of configuration for Rule 1, the Multiple
    ...
    Scale" src={useBaseUrl('/images/cf16.png')} />

### Steps for the configuration of Color Scheme Type

1.  Set the Rule Name to Rule 1 (see Figure below).

    <img alt="Condition Formatting Rule" src={useBaseUrl('/images/cf17.png')} />
...
5.  Based on the above set of configuration for Rule 1, the Multiple
    ...
    Scheme Type" src={useBaseUrl('/images/cf18.png')} />
...
> <img alt="AND or OR Logical Function" src={useBaseUrl('/images/cf19.png')} />
...
> <img alt="Condition 1" src={useBaseUrl('/images/cf20.png')} />

The below Figure shows the configuration for Condition 2.

> <img alt="Condition 2" src={useBaseUrl('/images/cf21.png')} />
...
> Function" src={useBaseUrl('/images/cf22.png')} />
...
> Function" src={useBaseUrl('/images/cf23.png')} />
...
> <img alt="Template 1" src={useBaseUrl('/images/ca1.png')} />

Now copy the JSON script from the Editor (see Figure below).

> <img alt="JSON Script from Template 1" src={useBaseUrl('/images/ca2.png')} />
...
> <img alt="JSON Script in Custom option" src={useBaseUrl('/images/ca3.png')} />
...
> API" src={useBaseUrl('/images/ca4.png')} />
...
> CSS" src={useBaseUrl('/images/cc1.png')} />
...
> CSS" src={useBaseUrl('/images/cc2.png')} />
...
> <img alt="Context Menu in Chart" src={useBaseUrl('/images/cm1.png')} />

After clicking the Context Menu icon, you will be able to view the Table
as shown in the below Figure.

> <img alt="Table view" src={useBaseUrl('/images/cm2.png')} />
...
> <img alt="Pin Column" src={useBaseUrl('/images/cm3.png')} />
...
> <img alt="Autosize This Column" src={useBaseUrl('/images/cm4.png')} />
...
> <img alt="Autosize All Columns" src={useBaseUrl('/images/cm5.png')} />
...
> <img alt="Filter option" src={useBaseUrl('/images/cm6.png')} />

You will be also able to filter the members by the respective check box
selection as shown below.

> <img alt="Filter option" src={useBaseUrl('/images/cm7.png')} />
...
> <img alt="Pivot option" src={useBaseUrl('/images/cm8.png')} />
...
> option" src={useBaseUrl('/images/cm9.png')} />
...
> dimension" src={useBaseUrl('/images/cm10.png')} />
